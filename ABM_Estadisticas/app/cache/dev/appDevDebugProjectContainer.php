...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'abmBundle', ($this->targetDirs[2].'/Resources/abmBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'abmBundle', ($this->targetDirs[3].'\\src\\abmestadisticas\\abmBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\abmestadisticas\\abmBundle\\Entity'))), 'abmestadisticas\\abmBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('abmBundle' => 'abmestadisticas\\abmBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e310dce0d7de01e7ac3452e9e6e53e38470b31833566b028c48572542ae2dc8f');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \abmEstadisticas\abmBundle\Services\Serializador A abmEstadisticas\abmBundle\Services\Serializador instance.
     */
    protected function getSerializadorService()
    {
        return $this->services['serializador'] = new \abmEstadisticas\abmBundle\Services\Serializador();
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'abmBundle:Form:forms.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'abmBundle:Form:forms.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'abmBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\abmestadisticas\\abmBundle/Resources/views'), 'abm');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'abmBundle' => 'abmestadisticas\\abmBundle\\abmBundle',
            ...
            'database_host' => '5.35.1.157',
            'database_port' => 1521,
            'database_name' => 'xe',
            'database_user' => 'desarrollo',
            'database_password' => 'desarrollo',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'abmBundle:Form:forms.html.twig',
            ),
