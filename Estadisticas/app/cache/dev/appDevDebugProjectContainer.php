...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebEstadisticasBundle', ($this->targetDirs[2].'/Resources/WebEstadisticasBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebEstadisticasBundle', ($this->targetDirs[3].'\\src\\Bundles\\WebEstadisticasBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'oci8', 'host' => '5.0.36.12', 'port' => 1521, 'dbname' => 'ESTAD', 'user' => 'root', 'password' => 'sle2014', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Bundles\\WebEstadisticasBundle\\Entity'))), 'Bundles\\WebEstadisticasBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('WebEstadisticasBundle' => 'Bundles\\WebEstadisticasBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_62796063f27cc25deddaf4ed153643361553d212d52511ce4ff3333416c14e1a');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Bundles\WebEstadisticasBundle\Services\Serializador A Bundles\WebEstadisticasBundle\Services\Serializador instance.
     */
    protected function getSerializadorService()
    {
        return $this->services['serializador'] = new \Bundles\WebEstadisticasBundle\Services\Serializador();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'WebEstadisticasBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Bundles\\WebEstadisticasBundle/Resources/views'), 'WebEstadisticas');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('EstadisticasSecret');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), ($this->targetDirs[2].'/../07_Estadisticas'), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WebEstadisticasBundle' => 'Bundles\\WebEstadisticasBundle\\WebEstadisticasBundle',
            ...
            'database_host' => '5.0.36.12',
            'database_port' => 1521,
            'database_name' => 'ESTAD',
            'database_user' => 'root',
            'database_password' => 'sle2014',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'es',
            'secret' => 'EstadisticasSecret',
            ...
            'kernel.secret' => 'EstadisticasSecret',
            ...
            'assetic.read_from' => ($this->targetDirs[2].'/../07_Estadisticas'),
            'assetic.write_to' => ($this->targetDirs[2].'/../07_Estadisticas'),
