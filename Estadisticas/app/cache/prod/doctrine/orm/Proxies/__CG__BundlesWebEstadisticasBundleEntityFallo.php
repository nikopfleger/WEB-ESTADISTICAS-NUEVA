 ...
 */
class Fallo extends \Bundles\WebEstadisticasBundle\Entity\Fallo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bundles\\WebEstadisticasBundle\\Entity\\Fallo' . "\0" . 'id', '' . "\0" . 'Bundles\\WebEstadisticasBundle\\Entity\\Fallo' . "\0" . 'anio', '' . "\0" . 'Bundles\\WebEstadisticasBundle\\Entity\\Fallo' . "\0" . 'division', '' . "\0" . 'Bundles\\WebEstadisticasBundle\\Entity\\Fallo' . "\0" . 'detalle', '' . "\0" . 'Bundles\\WebEstadisticasBundle\\Entity\\Fallo' . "\0" . 'link');
        }
