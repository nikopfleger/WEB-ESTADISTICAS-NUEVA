...
\t\t";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "00c0e5f_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_00c0e5f_0") : $this->env->getExtension('assets')->getAssetUrl("css/index_index_1.css");
            // line 10
  ...
  \t\t";
            ...
            // asset "00c0e5f"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_00c0e5f") : $this->env->getExtension('assets')->getAssetUrl("css/index.css");
            echo "\t\t\t<link rel=\"stylesheet\" href=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\" />
  \t\t";
...
\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(range(0, (twig_length_filter($this->env, (isset($context["news"]) ? $context["news"] : null)) - 1)));
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 68
            echo "\t\t\t\t\t";
            $context["novedad"] = $this->getAttribute((isset($context["news"]) ? $context["news"] : null), $context["i"], array(), "array");
            // line 69
            echo "\t\t\t\t\t<tr>
\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t<h4>
\t\t\t\t\t\t\t\t<a href=\"";
            // line 72
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["novedad"]) ? $context["novedad"] : null), "assetLink", array()), "html", null, true);
            echo "\" class=\"assetDescarga\" target=\"_blank\">
\t\t\t\t\t\t\t\t";
            // line 73
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["novedad"]) ? $context["novedad"] : null), "detalle", array()), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t</h4>
\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t<a href=\"";
            // line 78
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["novedad"]) ? $context["novedad"] : null), "assetDescarga", array()), "html", null, true);
            echo "\" download>
\t\t\t\t\t\t\t\t<h4>
\t\t\t\t\t\t\t\t\t";
            // line 80
            if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
                // asset "15beeb5_0"
                $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_15beeb5_0") : $this->env->getExtension('assets')->getAssetUrl("images/15beeb5_download_1.png");
                // line 81
                echo "   \t\t\t\t \t\t\t\t\t<img src=\"";
                echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
                echo "\" alt=\"Example\" />
\t\t\t\t\t\t\t\t\t";
                ...
                // asset "15beeb5"
                $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_15beeb5") : $this->env->getExtension('assets')->getAssetUrl("images/15beeb5.png");
                echo "   \t\t\t\t \t\t\t\t\t<img src=\"";
                echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
                echo "\" alt=\"Example\" />
\t\t\t\t\t\t\t\t\t";
